...
public class ScoreUt {
	...
	static public String description(int s) {
		...
		case 0 :
			return "High cards";
		case 1 :
			return "a pair of " + CardUtShared.getValChar((s>>ScoreUt.SCORE_SHIFT_SUBSC) & 0xf);
		case 2 :
			return "two pairs of " + CardUtShared.getValChar((s>>ScoreUt.SCORE_SHIFT_SUBSC) & 0xf) +
				" and " + CardUtShared.getValChar((s>>(ScoreUt.SCORE_SHIFT_SUBSC+ScoreUt.SCORE_SHIFT_CARDH)) & 0xf);
		case 3 :
			return "three of a kind of " + CardUtShared.getValChar((s>>ScoreUt.SCORE_SHIFT_SUBSC) & 0xf);
		case 4 :
			return "a straight, high of " + CardUtShared.getValChar((s>>ScoreUt.SCORE_SHIFT_SUBSC) & 0xf);
		case 5 :
			return "a flush";
		case 6 :
